...
import model.interfaces.ChestionarFinalDAO;

import javax.sql.DataSource;
import java.sql.*;
import java.util.List;

public class ChestionarFinalDAOImpl extends JdbcDaoSupport implements ChestionarFinalDAO {
    ...
    @Autowired
    public ChestionarFinalDAOImpl(DataSource driverManagerDataSource) {
