...
import projectManager.dao.ChestionarFinalDAO;
...
public class ChestionarFinalJDBCDAO extends JdbcDaoSupport implements ChestionarFinalDAO {
    ...
    private ParameterizedRowMapper<ChestionarFinal> chestionarFinalParameterizedRowMapper = new ParameterizedRowMapper<ChestionarFinal>() {
        @Override
        public ChestionarFinal mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            chestionarFinal.setChestionarFinal(rs.getBytes("chestionar_final"));
    ...
    public ChestionarFinal findByID(Integer id) {
        try {
            ...
            return getJdbcTemplate().queryForObject(findChestionarFinal, chestionarFinalParameterizedRowMapper);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public Integer create(final ChestionarFinal entity) {
        ...
        PreparedStatementCreator psc = new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
                ...
                ps.setBytes(2, entity.getChestionarFinal());
    ...
    public List<ChestionarFinal> getAll() {
        List<ChestionarFinal> result = getJdbcTemplate().query(CHESTIONAR_FINAL, chestionarFinalParameterizedRowMapper);
